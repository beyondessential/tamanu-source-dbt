...
select 
    ...
    anp.datetime,
    e.name as ethnicity,
    case when array_position(nd.diagnosis, 'Hypertension') is not null then 1 else 0 end as htn,
    case when array_position(nd.diagnosis, 'Diabetes type 1') is not null then 1 else 0 end as dm1,
    case when array_position(nd.diagnosis, 'Diabetes type 2') is not null then 1 else 0 end as dm2,
    ...
    case when array_position(nd.diagnosis, 'Other أخرى') is not null then 1 else 0 end as other_chronic,
