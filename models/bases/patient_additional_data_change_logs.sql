...
select
    ...
    {%- set columns = [
        ...
        {'expr': "fc.record_data ->> 'primary_contact_number'", 'name': 'primary_contact_number', 'is_direct_identifier': false},
        ...
        {'expr': "fc.record_data ->> 'ethnicity_id'", 'name': 'ethnicity_id', 'is_direct_identifier': true},
        ...
        {'expr': "fc.record_data ->> 'settlement_id'", 'name': 'settlement_id', 'is_direct_identifier': false},
        ...
        {'expr': "fc.record_data ->> 'country_of_birth_id'", 'name': 'country_of_birth_id', 'is_direct_identifier': true},
        {'expr': "fc.record_data ->> 'place_of_birth'", 'name': 'place_of_birth', 'is_direct_identifier': false},
        {'expr': "fc.record_data ->> 'birth_certificate'", 'name': 'birth_certificate', 'is_direct_identifier': false},
        ...
        {'expr': "fc.record_data ->> 'educational_level'", 'name': 'educational_level', 'is_direct_identifier': true},
        ...
        {'expr': "fc.record_data ->> 'insurer_policy_number'", 'name': 'insurer_policy_number', 'is_direct_identifier': false},
        {'expr': "fc.record_data ->> 'mother_id'", 'name': 'mother_id', 'is_direct_identifier': true},
