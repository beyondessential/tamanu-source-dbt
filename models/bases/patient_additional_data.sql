select
    ...
    {%- set columns = [
        ...
        {'expr': 'primary_contact_number', 'name': 'primary_contact_number', 'is_direct_identifier': false},
        ...
        {'expr': 'ethnicity_id', 'name': 'ethnicity_id', 'is_direct_identifier': true},
        ...
        {'expr': 'insurer_policy_number', 'name': 'insurer_policy_number', 'is_direct_identifier': false},
        {'expr': 'mother_id', 'name': 'mother_id', 'is_direct_identifier': true},
