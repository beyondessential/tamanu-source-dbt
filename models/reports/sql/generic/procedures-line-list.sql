select
    ...
    encounter_start_datetime as "{{ translate_string('encounterStartDate', 'Encounter start date') }}",
    encounter_end_datetime as "{{ translate_string('encounterEndDate', 'Encounter end date') }}",
