select
    ...
    concat_ws(', ', location_group, location) as "{{ translate_label('locationName', 'Location') }}",
    ...
    non_sensitive_completed_datetime as "{{ translate_label('labRequestCompletedDateTime', 'Completed date and time') }}",
