select
    ...
    to_char(start_datetime, '{{ var("date_format") }}') as "{{ translate_string('', 'Encounter start date') }}",
    to_char(end_datetime, '{{ var("date_format") }}') as "{{ translate_string('', 'Encounter end date') }}",
    to_char(start_datetime, '{{ var("time_format") }}') as "{{ translate_string('', 'Encounter start time') }}",
