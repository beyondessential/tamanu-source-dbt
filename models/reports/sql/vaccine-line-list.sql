select
    ...
    vaccine_category as "{{ translate_label_from_seed('vaccineCategory') }}",
    ...
    batch as "{{ translate_label_from_seed('vaccinationBatch') }}",
    given_by as "{{ translate_label_from_seed('vaccinationGivenBy') }}",
    recorded_by as "{{ translate_label_from_seed('vaccinationRecordedBy') }}",
    circumstances as "{{ translate_label_from_seed('vaccinationGivenElseWhereCircumstances') }}",
    given_elsewhere_by as "{{ translate_label_from_seed('vaccinationGivenElsewhereCountry') }}",
    not_given_clinician as "{{ translate_label_from_seed('vaccinationNotGivenClinician') }}",
    not_given_reason as "{{ translate_label_from_seed('vaccinationNotGivenReason') }}"
