select
    ...
    to_char(date_of_death, '{{ var("date_format") }}') as "{{ translate_label('patientDateOfDeath','Date of death') }}",
    ...
    to_char(last_surgery_date, '{{ var("date_format") }}') as "{{ translate_label('deathLastSurgeryDate', 'Last surgery date') }}",
    ...
    to_char(external_cause_date, '{{ var("date_format") }}') as "{{ translate_label('deathExternalCauseDate', 'External cause date') }}",
