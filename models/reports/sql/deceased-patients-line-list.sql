select
    ...
    date_of_death as "{{ translate_label('patientDateOfDeath') }}",
    ...
    last_surgery_date as "{{ translate_label('deathLastSurgeryDate') }}",
    reason_for_surgery as "{{ translate_label('deathReasonForSurgery') }}",
    manner_of_death as "{{ translate_label('deathMannerOfDeath') }}",
    external_cause_date as "{{ translate_label('deathExternalCauseDate') }}",
