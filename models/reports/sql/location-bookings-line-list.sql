select
    ...
    to_char(booking_start_datetime, '{{ var("datetime_format") }}') as "{{ translate_label_from_seed('bookingStartDateTime') }}",
    to_char(booking_end_datetime, '{{ var("datetime_format") }}') as "{{ translate_label_from_seed('bookingEndDateTime') }}",
    case
    ...
    end as "{{ translate_label_from_seed('bookingDuration') }}",
    location_group as "{{ translate_label_from_seed('bookingLocationGroup') }}",
    location as "{{ translate_label_from_seed('bookingLocation') }}",
    clinician as "{{ translate_label_from_seed('bookingClinician') }}",
    booking_type as "{{ translate_label_from_seed('bookingType') }}",
    booking_status as "{{ translate_label_from_seed('bookingStatus') }}"
