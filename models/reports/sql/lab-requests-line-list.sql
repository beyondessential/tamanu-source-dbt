select
    ...
    non_sensitive_tests as "{{ translate_label('labTestRequested', 'Test requested') }}",
    to_char(collected_datetime, '{{ var("datetime_format") }}') as "{{ translate_label('labRequestSampleCollectionDateTime', 'Sample collection date and time') }}",
    ...
    to_char(non_sensitive_completed_datetime, '{{ var("datetime_format") }}') as "{{ translate_label('labRequestCompletedDateTime', 'Completed date and time') }}",
