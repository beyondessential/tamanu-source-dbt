select
    ...
    collected_datetime as "{{ translate_label('labRequestSampleCollectionDateTime') }}",
    ...
    non_sensitive_completed_datetime as "{{ translate_label('labRequestCompletedDateTime') }}",
