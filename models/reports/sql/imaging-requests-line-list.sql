select
    ...
    requested_datetime as "{{ translate_label('imagingRequestDateTime', 'Request date and time') }}",
    ...
    completed_datetime as "{{ translate_label('imagingCompletedDateTime', 'Completed date and time') }}",
