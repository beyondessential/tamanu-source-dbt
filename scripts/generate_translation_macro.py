...
def generate_translation_macro():
    ...
    if deployment == "standard":
        standard = read_csv(os.path.join("csv", "report_translations_standard.csv"))
        localised = {}
    else:
        standard = read_csv(
            os.path.join(
                ...
                "tamanu_source_dbt",
                "csv",
                "report_translations_standard.csv",
            )
        )
        localised = read_csv(os.path.join("csv", f"report_translations_{deployment}.csv"))
...
Generated from csv/report_translations_standard.csv and project-specific translations.
