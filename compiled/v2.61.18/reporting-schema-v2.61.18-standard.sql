...
providers as (
    select * from "reporting"."ref__provider"
),
...
create or replace view "reporting"."metric__ed_imaging_request" as (
...
create or replace view "reporting"."metric__ed_procedure" as (
...
create or replace view "reporting"."metric__opd_visit_department" as (
...
create or replace view "reporting"."metric__lab_request" as (
...
with measurement as (
    select * from "reporting"."clinical__measurement"
