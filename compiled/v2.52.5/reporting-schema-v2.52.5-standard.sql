...
insurance_pivot as (
    select
        invoice_product_id
        , max(case when invoice_insurance_plan_id = 'insuranceProduct-BSPPremierCare' then coverage_value end)
            as cov_1
        , max(case when invoice_insurance_plan_id = 'insuranceProduct-BSPPremierPlus' then coverage_value end)
            as cov_2
        , max(case when invoice_insurance_plan_id = 'insuranceProduct-BSPValueHealthCare' then coverage_value end)
            as cov_3
        , max(case when invoice_insurance_plan_id = 'insuranceProduct-FijiCareBronze' then coverage_value end)
            as cov_4
        , max(case when invoice_insurance_plan_id = 'insuranceProduct-FijiCareGold' then coverage_value end)
            as cov_5
        , max(case when invoice_insurance_plan_id = 'insuranceProduct-FijiCareSilver' then coverage_value end)
            as cov_6
...
select
    ...
    end as "Insurance: BSP Premier Care"
    , case
        when ip.insurable = false then 'n/a'
        else cast(
            coalesce(
    ...
    end as "Insurance: BSP Premier Plus"
    , case
        when ip.insurable = false then 'n/a'
        else cast(
            coalesce(
    ...
    end as "Insurance: BSP Value Health Care"
    , case
        when ip.insurable = false then 'n/a'
        else cast(
            coalesce(
    ...
    end as "Insurance: Fiji Care Bronze"
    , case
        when ip.insurable = false then 'n/a'
        else cast(
            coalesce(
    ...
    end as "Insurance: Fiji Care Gold"
    , case
        when ip.insurable = false then 'n/a'
        else cast(
            coalesce(
    ...
    end as "Insurance: Fiji Care Silver"
    , case
        when ip.insurable = false then 'n/a'
        else cast(
            coalesce(
