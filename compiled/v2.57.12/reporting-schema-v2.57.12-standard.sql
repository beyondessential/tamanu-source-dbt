...
outpatient_encounters_banded as (
    ...
    case
        when age_years between 0 and 14   then '0-14 years'
        when age_years between 15 and 24  then '15-24 years'
        when age_years between 25 and 44  then '25-44 years'
        when age_years between 45 and 59  then '45-59 years'
        when age_years between 60 and 74  then '60-74 years'
        when age_years between 75 and 120 then '75+ years'
        else 'Unknown age'
    end
 as age_group
...
create or replace view "reporting"."metric__emergency_care" as (
