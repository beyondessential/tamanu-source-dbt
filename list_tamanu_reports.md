...
## Standard
### Lab test summary msf

**Report Description**

This report provides a summary of lab test data aggregated by epidemiological week with facility-specific metrics including new patients tested, test counts by type, and status breakdowns for North and South facilities.
...
### Lab follow ups line list

**Report Description**

This report provides a list of lab follow-up schedules for patients with non-communicable diseases (NCDs).

**Filters**

Follow-up Status, Test Type, NCD
...
### Survey medication dispensing

**Report Description**

This report shows count of patients and doses dispensed for a given drug within a specified date range.

**Filters**

Facility - المرفق, Drug - الدواء
